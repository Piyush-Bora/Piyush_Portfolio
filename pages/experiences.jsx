      ...
      <VerticalTimeline>
        ...
        >
          ...
          <ul className="list-disc px-5 font-poppins text-slate-600">
            <li>
              Developed an API to retrieve user location data and utilized it to
              automatically fill in the country code for all lead-generation
              modules. This boosted lead generation by 5% and facilitated
              traffic analysis by country.
            </li>
            <li>
              Revamped over 5 websites in Webflow for a cleaner and modern UI,
              positively impacting the user experience.
            </li>
            <li>
              Enhanced tracking capabilities by adding GTM (Google Tag Manager)
              events for better analytics.
            </li>
            <li>
            ...
            <li>
              ...
              high-quality solutions and fostering a positive team atmosphere.
            </li>
          </ul>
