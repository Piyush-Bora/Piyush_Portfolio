const Projects = [
    {
        ...
        description: "Developed a website for easing the job finding for daily wage workers. The recruiters post their job requirements and the worker then chooses the job according to his preferences.",
    ...
    },
    {
        ...
        description: "Made a news Reading Website for daily news updates. This app fetches data from an API category-wise and displays it in the form of cards to the user which are redirected to the article.",
    ...
    },
    {
        ...
        description: "Developed a website for easing the task of messaging someone on WhatsApp without ssaving their phone number. User has to enter the phone Number and that contact will open in whatsApp.",
        tech: ["Tailwind-CSS", "ReactJS"],
